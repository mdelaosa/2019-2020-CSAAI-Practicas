...
const value_rojo = document.getElementById('value_rojo');
const value_verde = document.getElementById('value_verde');
const value_azul = document.getElementById('value_azul');
